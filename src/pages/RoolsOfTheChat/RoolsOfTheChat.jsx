...
function RoolsOfTheChat() {
    return (
        <div className={css.container}>
            ...
            <div>
                <p>This privacy policy sets out the obligations and rules regarding the collection, use and disclosure of user’s personal information when communicating on TeamChat. We take the privacy of our users' information seriously and are committed to protecting their privacy.</p>
                <ol className={css.list}>
                    ...
                    <li className={css.item}>Use of cookies: Our Chat for communication may use cookies and other technologies to collect information and improve the user experience. Users have the option to disable cookies in their web browser settings, but this may affect the functionality of TeamChat.</li>
                ...
                <p>This privacy policy is for your protection and remains binding on all TeamChat users. If you have any questions about our privacy policy, please contact us using the contact information provided on our website.</p>
            </div>
